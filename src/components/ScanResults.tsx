...
import { searchGoogleCSE } from '../utils/googleCSE';
        ...
        <section className="max-w-4xl mx-auto text-center mb-16 mt-8 animate-fade-in">
          <ScrollAnimationWrapper direction="down" className="mb-6">
            ...
            <p className="text-xl md:text-2xl text-slate-700 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed">
              <span className="font-semibold">Discover your digital footprint</span> and gain insights into your online exposure and privacy risks.
            </p>
            ...
            {[
              {
                ...
                desc: 'Uncover public data tied to you and understand what information is easily accessible online.'
              },
              {
                icon: <AlertCircle className="w-8 h-8 text-violet-600 dark:text-violet-400" />,
                title: 'Analyze Risks',
                desc: 'Get a breakdown of your vulnerability based on discovered data and potential misuse scenarios.'
              },
              {
                icon: <Shield className="w-8 h-8 text-violet-600 dark:text-violet-400" />,
                title: 'Secure Yourself',
                desc: 'Use actionable advice to minimize your digital footprint and enhance personal cybersecurity.'
              }
            ].map((item, idx) => (
