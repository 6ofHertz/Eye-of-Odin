    ...
    <section id="about" className="w-full max-w-5xl mx-auto py-16 px-4">
      <div className="text-center mb-12">
        <div className="flex items-center justify-center gap-2 mb-4">
          <Eye className="w-8 h-8 text-amber-500 eye-glow" />
        </div>
          ...
          <CardContent className="pt-4 text-slate-600 dark:text-slate-400">
            <ol className="list-decimal list-inside space-y-3">
              <li className="flex items-start">
                <span className="bg-amber-50 dark:bg-amber-900/20 rounded-full h-6 w-6 flex items-center justify-center mr-2 flex-shrink-0 border border-amber-200 dark:border-amber-700/50 text-sm text-amber-500">1</span>
              ...
              <li className="flex items-start">
                <span className="bg-amber-50 dark:bg-amber-900/20 rounded-full h-6 w-6 flex items-center justify-center mr-2 flex-shrink-0 border border-amber-200 dark:border-amber-700/50 text-sm text-amber-500">2</span>
              ...
              <li className="flex items-start">
                <span className="bg-amber-50 dark:bg-amber-900/20 rounded-full h-6 w-6 flex items-center justify-center mr-2 flex-shrink-0 border border-amber-200 dark:border-amber-700/50 text-sm text-amber-500">3</span>
              ...
              <li className="flex items-start">
                <span className="bg-amber-50 dark:bg-amber-900/20 rounded-full h-6 w-6 flex items-center justify-center mr-2 flex-shrink-0 border border-amber-200 dark:border-amber-700/50 text-sm text-amber-500">4</span>
      ...
      <div className="mt-12 p-8 bg-gradient-to-r from-white to-amber-50 dark:from-slate-800 dark:to-slate-800/80 rounded-3xl border border-amber-100 dark:border-amber-900/30 text-center shadow-lg">
        ...
        <Card className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-lg greek-column">
          ...
          <CardContent className="pt-4 text-slate-600 dark:text-slate-400">
            ...
            <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-lg border border-slate-200 dark:border-slate-700 font-mono text-sm text-slate-700 dark:text-slate-300">
              ...
              <p className="text-amber-500">const firebaseConfig = &#123;</p>
